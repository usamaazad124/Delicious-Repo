...
const Navbar=()=> {
  ...
  return (
    <>
      <div
        className="h-663_ bg-no-repeat bg-center w-full bg-cover "
        style={{ backgroundImage: `url(${Headerbg})` }}
      >
        <div className={`${navBar? "bg-white":"header-gradient"} navbar md:flex flex-row justify-between hidden items-center m-0 contanier  z-10 mx-auto p-5 text-white px-10 shadow-sm fixed inset-x-0`}>
          ...
          <svg
            ...
            className={ `${navBar? "text-black":"text-white"} w-40 desktop-logo`}
          >
            <path
              id="logo"
          ...
          <ul className={`${navBar? "text-black":"text-white"} flex flex-row justify-between  uppercase lg:w-[28%] md:w-[46%] text-sm `}>
            <li className={`${navBar? "hover:border-b-black":"hover:border-b-white"} border-b border-transparent text-sm font-semibold  `}>
             <NavLink
                to="/"
                className={({ isActive }) =>
                  `${
