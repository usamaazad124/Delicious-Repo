...
import navInnerbg from "../../images/menu-background.png";
...
const MobileNav = () => {
  ...
  return (
    <>
      <div
        className="header block md:hidden bg-cover bg-no-repeat bg-center"
        style={{ backgroundImage: `url(${headerBG})` }}
      >
        <div
          className={`${
            color ? "bg-white" : "desktop-nav"
          } navigation flex justify-between items-center w mx-auto py-4 px-3 fixed top-0 inset-x-0 transition-all z-10`}
        >
          <a href="/" className="cursor-pointer ">
            <svg
              className={`${color ? "text-black" : "text-white"}
             desktop-logo h-9 transition-all`}
              id="Layer_1"
              data-name="Layer 1"
        ...
        <div
          ...
          } bg-[#f4f4f4] transition-opacity duration-500 navInner h-screen inset-x-0 z-20 fixed top-0 bg-40%_ bg-no-repeat bg-right py-4 px-3`}
          style={{ backgroundImage: `url(${navInnerbg})` }}
        >
          <div
            className={`bg-transparent navigation flex justify-between items-center mx-auto `}
          >
            <a href="/" className="cursor-pointer ">
              <svg
                className={`text-footer-text-grey
             desktop-logo h-9 transition-all`}
                id="Layer_1"
                data-name="Layer 1"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <ul className="mt-16 relative z-10 `">
            <li className="mb-4 font-freight text-3xl">
              <NavLink
                to="/"
                className={({ isActive }) =>
                  `${
